...
class method   extends adminbaseclass
{
	...
	function saveshop()
	{
	  ...
	  $attrid =  $temparray[1];
	   ...
	   $this->mysql->insert(Mysite::$app->config['tablepre'].'shopattr',$attrdata);
			...
			//http://m6.waimairen.com/index.php?ctrl=adminpage&action=shop&module=saveshop&datatype=json&random=597&maphone=15656555555&shopname=dsdsad&shopaddress=dsadasd&shoptype=0_214&shoplicense=%2Fupload%2Fuser%2F20160407175306662.png&username=&password=&password2=&subtype=2&laiyuan=1
			print_r($subtype);
			exit;
			/*检测*/
			$data['username'] = IReq::get('username');
	...
	function resetdefualt(){
	  ...
	  ICookie::set('adminshopid',$shopid,86400);
		$link = IUrl::creatUrlEx($this->mid,'shopcenter/useredit');

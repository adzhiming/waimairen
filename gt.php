...
require_once(dirname(__FILE__) . '/gt/' . 'IGt.Push.php');
require_once(dirname(__FILE__) . '/gt/' . 'igetui/IGt.AppMessage.php');
require_once(dirname(__FILE__) . '/gt/' . 'igetui/IGt.APNPayload.php');
require_once(dirname(__FILE__) . '/gt/' . 'igetui/template/IGt.BaseTemplate.php');
require_once(dirname(__FILE__) . '/gt/' . 'IGt.Batch.php');
require_once(dirname(__FILE__) . '/gt/' . 'igetui/utils/AppConditions.php');
...
define('APPKEY','ep43YFIDLEAytvGh9gs3o1');//
define('APPID','4bu2P8NO0tAvNrmgzMoO38');
define('MASTERSECRET','bqboL9p46M8rxkGcv9N2D2');
define('CID','d50ab4d177644faacea99b437a686b08');
define('DEVICETOKEN','');
define('Alias','请输入别名');
echo 'xxxx';
...
function IGtNotificationTemplateDemo(){
    ...
    $template->set_title("测试推送");//通知栏标题
    $template->set_text("推送内容");//通知栏内容
